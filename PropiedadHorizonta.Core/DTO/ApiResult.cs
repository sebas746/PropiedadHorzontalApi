...
using PropiedadHorizontal.Core.Extensions;
using System;
...
namespace PropiedadHorizontal.Core.DTO
{
    public class ApiResult<T>
    {
        ...
        /// </returns>
        public static async Task<ApiResult<T>> CreateAsync(IQueryable<T> source, int pageIndex, int pageSize, string sortColumn = null, string sortOrder = null, string filterColumn = null,
